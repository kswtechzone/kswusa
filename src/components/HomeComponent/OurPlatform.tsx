      ...
      <div className="flex flex-wrap justify-center items-center ">
        ...
        <div className="flex justify-center flex-wrap flex-row space-x-4 md:space-x-8 lg:space-x-12 xl:space-x-16">
          ...
          <PlartformCard
            ...
            link="https://thn.kswtechzone.com.np/"
          />
        </div>
        <div className="flex justify-center flex-wrap space-x-4 md:space-x-8 lg:space-x-12 xl:space-x-16 md:mt-12 mt-2">
          <PlartformCard
            ...
            link="https://www.ghantaaghar.com"
          />
          ...
          <PlartformCard
            ...
            link="https://blog.kswtechzone.com.np/"
          />

          <PlartformCard
            title="KIRA"
            desc="Take the first step towards a future powered by innovation and technology!"
            props="mr-0 sm:mr-6"
            imgSrc="https://i.all3dp.com/wp-content/uploads/2021/05/25100308/20181222_133954.jpg"
            link="https://kira.kswtechzone.com.np/"
          />
        </div>
      </div>
    </>
